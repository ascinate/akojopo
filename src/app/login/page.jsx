                                    ...
                                    <div className="card-body">
                                        ...
                                        <form className='card-form'>
                                            ...
                                            <div className='login-input-margin '>
                                                ...
                                                <Link href='/' className='forgetpassword login-input-margin'>Forget Password?</Link>
                                            </div>
                                            <div className='login-btn-div login-input-margin'>
                                                <button className='login-btn'>Login in</button>
                                            </div>
                                            <p className='text-center'> <span className='haveaccount'>Don&#39;t have an account ?</span> <Link href='/'>Sign Up</Link></p>
                                        </form>
