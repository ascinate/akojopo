                        ...
                        <div className='row'>
                            <div className='col-12'>
                                <section className='contribute-section'>
                                    <h2>Want to <span>contribute?</span></h2>
                                    <div className='wrapper'>
                                        <div className='contribute-content'>
                                            <article className='contribute-img-col1'>
                                                <Image
                                                    src={contributeImg1}
                                                    alt="My Logo"
                                                    width={419}
                                                    height={530}
                                                 className='contribute-img-col2-image1'/>
                                            </article>
                                            <div className='contribute-img-col2-div'>
                                                <Image
                                                    src={contributeImg2}
                                                    alt="My Logo"
                                                    width={199}
                                                    height={405}
                                                    class='contribute-img-col2' />
                                            </div>
                                            ...
                                            <article className='contribute-card'>
                                                ...
                                                <button>Doscover More</button>
                                            </article>
                                        </div>
                                    </div>

                                </section>
                                {/* Want to contribute end */}
                            </div>
                        </div>
                    </div>
                </article>
